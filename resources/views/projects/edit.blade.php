                ...
                <div class="d-flex flex-wrap gap-3 @error('technologies') is-invalid @enderror">
                    @foreach ($technologies as $technology)
                        <div class="form-check">
                            <input name="technologies[]" @checked(in_array($technology->id, old('technologies', $project->technologies->pluck('id')->all()))) class="form-checked-input" type="checkbox" value="{{ $technology->id }}" id="flexCheckDefault">
